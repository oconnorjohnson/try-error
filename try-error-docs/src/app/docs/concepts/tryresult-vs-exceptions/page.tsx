            ...
            <table className="w-full border-collapse border border-slate-300 text-xs sm:text-sm">
              <thead>
                <tr className="bg-slate-50">
                  <th className="border border-slate-300 px-2 sm:px-4 py-2 text-left">
                    Aspect
                  </th>
                  <th className="border border-slate-300 px-2 sm:px-4 py-2 text-left">
                    tryError
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-slate-300 px-2 sm:px-4 py-2 text-green-600">
                    ✅ Errors visible in types
                  </td>
                  <td className="border border-slate-300 px-2 sm:px-4 py-2 text-red-600">
                ...
                <tr>
                  ...
                  <td className="border border-slate-300 px-2 sm:px-4 py-2 text-yellow-600">
          ...
          <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-4 mb-4 sm:mb-6">
            <div className="overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <CodeBlock
                  language="typescript"
                  title="Exception-based Approach"
                >
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
              ...
              <ul className="space-y-1 sm:space-y-2 text-blue-700 text-xs sm:text-sm">
        ...
        <section>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
            <p className="text-yellow-800 text-sm sm:text-base">
              <strong>Benchmark Results:</strong> In typical scenarios, tryError
              shows 2-10x better performance for error cases and identical
              performance for success cases compared to try/catch.
            </p>
          </div>
